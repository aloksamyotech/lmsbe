...
router.get("/user/availablePurchaseBook", availablePurchaseBook);
...
router.get("/user/getReceivBookInvoice/",getReceivBookInvoice)
...
router.get("/user/getBookAllotmentHistory/:id", getBookAllotmentHistory);
router.get(
